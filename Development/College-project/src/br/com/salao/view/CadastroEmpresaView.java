...
public class CadastroEmpresaView extends AnchorPane {
	...
	public ComboBox cbPaisEmp, cbEstadoEmp,cbCidadeEmp, cbPaisAd, cbEstadoAd,cbCidadeAd, cbCargoAd;

	public TextField tfNomeFantasia, tfRazaoSocial, tfCNPJ, tfTelOneEmp,
			tfTelTwoEmp, tfEmailEmp, tfCepEmp, tfBairroEmp,
			tfRuaEmp, tfNumeroEmp, tfComplementoEmp, tfCredNiver, tfCredFidel,
			tfFinalExpediente;

	public TextField tfNome, tfCTPS, tfRG, tfCPF, tfSalario,
			tfTelOneAd, tfTelTwoAd, tfEmailAd,tfCepAd, tfBairroAd, tfRuaAd, tfNumeroAd, tfComplementoAd;
	...
	private void iniComponents() {
		...
		getChildren().addAll(lbAdmin, lbNome, lbCTPS, lbRG, lbCPF, lbCargo, lbSalario,
				lbDataNasc, lbTelOneAd, lbTelTwoAd, lbEmailAd, lbPaisAd,
				lbEstadoAd, lbCepAd, lbCidadeAd, lbBairroAd, lbRuaAd, lbNumeroAd,
				lbComplementoAd);
		
		getChildren().addAll(btCadastrar, btCancelar,cbPaisEmp, cbEstadoEmp, cbCidadeEmp, cbPaisAd, cbEstadoAd,cbCidadeAd, cbCargoAd,dpDataNascimento);
		
		getChildren().addAll(tfNomeFantasia, tfRazaoSocial, tfCNPJ, tfTelOneEmp,
				tfTelTwoEmp, tfEmailEmp, tfCepEmp, tfBairroEmp,
				tfRuaEmp, tfNumeroEmp, tfComplementoEmp, tfCredNiver, tfCredFidel,
				tfFinalExpediente);
		
		getChildren().addAll(tfNome, tfCTPS, tfRG, tfCPF, tfSalario,
				tfTelOneAd, tfTelTwoAd, tfEmailAd,tfCepAd,
				tfBairroAd, tfRuaAd, tfNumeroAd, tfComplementoAd);
