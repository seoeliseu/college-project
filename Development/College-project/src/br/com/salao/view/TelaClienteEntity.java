...
public class TelaClienteEntity extends AnchorPane{
	...
	private void iniComponents(){
		...
		btAgendarServico = new Button("+ Serviço");
		...
		btEmitirSegundaVia = new Button("Emitir 2ª via pagamento");
