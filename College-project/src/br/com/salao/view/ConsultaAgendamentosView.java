...
public class ConsultaAgendamentosView extends AnchorPane{
	...
	private void iniComponents(){
		...
		lbFuncionario = new Label("Funcionário: ");
		...
		colFuncionario = new TableColumn<>("Funcionário");
		...
		colHoraInicial = new TableColumn<>("Horário Inicial");
		colHoraInicial.setMinWidth(200);
		colHoraFinal = new TableColumn<>("Horário Final");
