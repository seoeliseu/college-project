...
public class TelaUserAdminView extends VBox{
	...
	private void iniComponents(){
		...
		mRelatorio = new Menu("Relatório");
		
		//Cadastros
		miAddCliente = new MenuItem("Novo cliente");
		miAddServico = new MenuItem("Serviço");
		miAddFuncionario = new MenuItem("Funcionário");
		
		//Consultas
		miShowAgendaGeral = new MenuItem("Agendamentos");
		miShowDadosUsuario = new MenuItem("Dados de usuário");				
		miFindCliente = new MenuItem("Cliente");
		miShowServicos = new MenuItem("Serviços");
		miFindFuncionario = new MenuItem("Funcionário");
		
		//Editar
		miSetCliente = new MenuItem("Cliente");
		miSetServicoAgenda = new MenuItem("Serviço agendado");
		miSetServico = new MenuItem("Serviço");
		miSetFuncionario = new MenuItem("Funcionário");
		miSetEmpresa = new MenuItem("Empresa");
		miSetParamentros = new MenuItem("Parâmetros");
